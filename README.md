...
This GitHub Action analyses Java and TypeScript / JavaScript projects using Feather City and generates 3D HTML visualizations of a "software map" that can be explored to find anomalous classes.

## Features

- Analyses Java and TypeScript / JavaScript source code with various metrics (Lines of Code, Cyclomatic Complexity, Number of Methods, etc.)
  ...
  analyse:
    ...
    steps:
      ...
      - name: Run Feather City Analysis
        uses: livcristi/feather-city-action/java@v0 # or livcristi/feather-city-action/typescript@v0 for ts / js projects
```
